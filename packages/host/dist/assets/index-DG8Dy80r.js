import { _ as __vitePreload } from './index-BV5jd_WD.js';
...
const moduleMap = {'@plumejs/core':{get:()=>()=>__federation_import$1(new URL('__federation_shared_@plumejs/core-KSo_na-c.js', import.meta.url).href),import:true}};
...
const remotesMap = {
'remoteTodo':{url:'http://localhost:4171/assets/remoteEntry.js',format:'esm',from:'vite'}
};
                ...
                const wrapShareModule = remoteFrom => {
                  return merge({
                    '@plumejs/core':{'4.1.3':{get:()=>get(new URL('__federation_shared_@plumejs/core-KSo_na-c.js', import.meta.url).href, remoteFrom), loaded:1}}
...
const __federation_var_remoteTodoInput = await __federation_method_getRemote("remoteTodo" , "./Input");
 let {TodoInput} = __federation_var_remoteTodoInput;
console.log(TodoInput);
let AppComponent = class {
  todos = [];
  render() {
    return html`<h1>This is host application</h1>
      <app-todo-input
        onsubmit=${(e) => {
